        ...
        <div className="flex items-center gap-2" dir="rtl">
          ...
          <div className="flex items-center gap-2 ms-auto">
            <button
              ...
              className="flex items-center gap-2 px-3 py-1.5 rounded-xl text-sm font-medium text-sh-text-muted border border-sh-yellow-light bg-sh-yellow-light hover:bg-sh-yellow-light hover:text-sh-text transition-colors"
            >
              <Mail size={14} />
              שלח דו"ח
            </button>
            <button
              ...
              className="flex items-center gap-2 px-3 py-1.5 rounded-xl text-sm font-medium text-sh-text-muted border border-sh-yellow-light bg-sh-yellow-light hover:bg-sh-yellow-light hover:text-sh-text transition-colors disabled:opacity-60"
            >
              <FileDown size={14} />
